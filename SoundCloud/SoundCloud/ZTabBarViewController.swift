...
class ZTabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        searchNavigationVC.tabBarItem = UITabBarItem(title: TextManager.search, image: ImageManager.search, tag: 1)
        ...
        yourLibraryNavigationVC.tabBarItem = UITabBarItem(title: TextManager.library, image: ImageManager.library, tag: 2)
